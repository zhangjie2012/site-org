...
|       x | 一年   | 一月  | 一周  | 一日    |
|   99.9% | 8h45m  | 43m   | 10m5s | 1m26s   |
|  99.99% | 52m34s | 4m19s | 1m    | 9s      |
| 99.995% | 26m17s | 2m10s | 30s   | 4s      |
| 99.999% | 5m15s  | 26s   | 6s    | 不足 1s |
...
- [[https://www.okd.io/][OKR]] OpenShift 的社区版本，红帽 OpenShift 应该是业内做的比较早的的企业级混合云（PaaS），算是行业标杆吧
