...
** Windows 10
   ...
   Windows 下 Projectile 报错 =’tr’ is not recognized as an internal or external command, operable program or batch file./")= ，设置 =(setq projectile-git-submodule-command nil)= 即可[fn:4]。
