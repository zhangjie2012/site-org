...
Windows Terminal 很卡。直接使用 ssh 的方式连接。
...
1. Xshell 7 选项高级里没有入口可以设置了
2. =C:\Users\系统用户名\Documents\NetSarang Computer\7\Xshell\Sessions\default= 中的 =BellMode= 值设置为 0。
...
设置代理：https://gitlab.com/JerryZhang2012/dotfiles
