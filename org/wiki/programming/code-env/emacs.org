...
| [[https://github.com/tumashu/cnfonts][cnfonts]]            | GUI 中英文混排等宽                   |                                                                      |
...
使用 [[https://github.com/tumashu/cnfonts][cnfonts]] 进行中英文混排的配置，终结了 GUI 上字体的折腾（虽然不是特别完美）。

从今天开始，All in GUI，再见终端。

终于可以使用自己喜爱的主题，而不用考虑终端是否兼容了~
