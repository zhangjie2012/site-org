...
- [[https://github.com/dominikh/go-mode.el][go-mode]] 是 go 的 mirror mode，语法高亮和一些简单的 IDE 功能，依赖 go-guru，go-rename
- [[https://github.com/emacs-lsp/lsp-mode/][emacs-lsp/lsp-mode]] 是 [[https://langserver.org/][LSP]] 的 Emacs 实现。只是一个客户端，server 用的是 [[https://github.com/golang/tools/tree/master/gopls][gopls]]，还依赖 goimports
