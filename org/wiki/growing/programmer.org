...
+ 编码字体
  ...
  - [[https://github.com/adobe-fonts/source-code-pro][Source Code Pro]] 用了五年多，现在依旧认为是最美的的编程字体，最近才切换到 Fira code，Fira code 也很好看，而且棱角分明一些
...
+ TODO
  - +[[https://www.wunderlist.com/zh/][Wunderlist]]：支持 Windows 和 Mac 平台，[[https://github.com/edipox/wunderlistux][Ubuntu]]+ ，部分功能已经用 org-mode 代替了。 _gtd 是一个很艰难的事，与工具无关。_
...
+ UML
    ...
    - Windows 下当然是 Visio 啦

UML 绘图始终觉得 Visio 做的最好，各种在线（比如 ProcessOn）的我也尝试过，效率太低了。
...
+ 科学上网
  + [[https://github.com/shadowsocks/ShadowsocksX-NG][ShadowsocksX-NG]]，没有稳定的梯子，现在都改成了 [[https://github.com/leadscloud/ShadowsocksX-NG-R/releases][SSR]] 了，
