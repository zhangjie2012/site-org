...
Linux 发行版相关软件见 [[file:~/site/org/wiki/desktop/linux-mint.org][Linux Mint]] 。
...
+ 云笔记
  - [[https://note.youdao.com/][有道云笔记]]，支持 Windows 和 Mac 平台，Mac 体验优于印象笔记，不支持 Ubuntu，手机上广告很多。开始使用 org-mode 之后，云笔记也不咋用了。
+ TODO
