...
+ 编码字体（当然是等宽字体）：
  ...
  - 中英文等宽等高：[[https://github.com/be5invis/Sarasa-Gothic][更纱黑体]] 一般的字体中英文等宽但是不等高，这款字体等宽又等高，但是总体略丑 [[https://mirrors.tuna.tsinghua.edu.cn/github-release/be5invis/Sarasa-Gothic/][清华下载镜像]]
  - 不折腾字体了，英文 [[https://github.com/microsoft/cascadia-code][cascadia-code]]，中文更纱黑体，Emacs 使用 [[https://github.com/tumashu/cnfonts][cnfonts]] 实现中英文混排
+ 包管理工具
...
+ 命令行使用优化
  ...
  - [[https://github.com/wting/autojump][autojump]]：目录快捷跳转，Windows 也支持
