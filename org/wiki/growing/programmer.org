...
+ 科学上网
  + MacOS [[https://github.com/shadowsocks/ShadowsocksX-NG][ShadowsocksX-NG]] [[https://github.com/leadscloud/ShadowsocksX-NG-R/releases][SSR]]
  + iOS Potatso Lite
+ 包管理工具
...
+ Chrome 插件
  ...
  - FireShot：网页截图
  - [[https://github.com/FelisCatus/SwitchyOmega][SwitchyOmega]]
+ 代码生成图片
