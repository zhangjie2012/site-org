...
* 办公硬件
  ...
  + 机械键盘
    ...
    - DURGOD 杜伽 K320 茶轴，五六百，支持无线和蓝牙，目前在用这款
  + 显示器
...
* 编码与环境
  ...
  + 编码字体（当然是等宽字体）：
    - 英文等宽 [[https://github.com/tonsky/FiraCode][Fira Code]]、 [[https://github.com/adobe-fonts/source-code-pro][Source Code Pro]]、[[https://www.jetbrains.com/lp/mono/][Jetbrains Mono]]（官方推荐 13 号字体和 1.20 倍行号，可是太小了）、[[https://github.com/supercomputra/SF-Mono-Font][SF Mono]] 苹果官方出的，目前在用
...
** 其它
   ...
   + 科学上网
     ...
     - +[[https://github.com/shadowsocks/ShadowsocksX-NG][ShadowsocksX-NG]]，没有稳定的梯子，现在都改成了 [[https://github.com/paradiseduo/ShadowsocksX-NG-R8][ShadowsocksX-NG-R8]] 了+ 目前 MacOS 使用 [[https://github.com/yichengchen/clashX][clashX]] ，Windows 和 Linux 据说都支持，但是没试过
     - iOS Potatso Lite
   + 刻录
