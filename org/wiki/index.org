...
- 基础命令：[[file:devops/awk.org][awk]]，[[file:devops/sed.org][sed]]，[[file:devops/tar.org][tar]]，[[file:devops/rsync.org][rsync]]，[[file:devops/cron.org][crontab]]，[[file:devops/find.org][find]]
- 操作系统：[[file:devops/ubuntu.org][Ubuntu]]
...
- [[file:devops/k8s-resource.org][资源]]：各种帅帅的图
