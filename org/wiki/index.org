...
- [[file:devops/k8s-deployment-strategies.org][K8s 部署策略]]：几种常见的部署策略
- [[file:devops/k8s-resource.org][资源]]：各种帅帅的图，以及 K8s 的资源连接
...
- [[file:programming/frontend/antd.org][antd]]
