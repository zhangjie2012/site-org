...
** 系统运维
   ...
   - 基础命令 :: [[file:devops/awk.org][awk]]，[[file:devops/sed.org][sed]]，[[file:devops/tar.org][tar]]，[[file:devops/rsync.org][rsync]]，[[file:devops/cron.org][crontab]]，[[file:devops/find.org][find]]，[[file:devops/process-mgr.org][进程管理]]，[[file:devops/ssh.org][SSH]]，[[file:devops/curl.org][curl]]
...
** Go
   ...
   - [[file:programming/go/build-web-server-stack.org][构建 Go Web 服务技术栈]] 侧重技术 /持续更新/
   ...
   - [[file:programming/go/go-mongo-driver.org][Go Mongo Driver]] 使用技巧
