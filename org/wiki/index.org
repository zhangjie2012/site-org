...
- 操作系统 :: [[file:devops/ubuntu.org][Ubuntu]]，[[file:devops/ops-faq.org][系统 FAQ]]
...
- 官方文档
  + 概述：[[file:devops/kubernetes-components.org][组件]]、[[file:devops/kubernetes-overview-api.org][API]]、[[file:devops/kubernetes-overview-objects.org][对象]]
  + 架构：[[file:devops/kubernetes-architechture-nodes.org][节点]]、[[file:devops/kubernetes-architecture-controller.org][控制器]]、[[file:devops/kubernetes-architecture-master-node-communication.org][Master-Node 通信]]
  + 容器：[[file:devops/kubernetes-containers-images.org][镜像]]、[[file:devops/kubernetes-containers-container-environment-variables.org][容器环境变量]]
  + [[file:devops/k8s-kubectl.org][kubectl]] kubectl 使用文档
...
- [[file:devops/promethues.org][基于 Prometheus 的监控告警]]
