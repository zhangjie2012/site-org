...
** TODO 滑动窗口日志（Sliding Window log）

** 滑动窗口计数器（Sliding Window counter）

#+CAPTION: image via https://blog-1252349778.cos.ap-beijing.myqcloud.com/2022/sliding_window.png
...
如上图，假设一分钟总的限制是 50，当前时间为 =01:20= ，已经计数了 20 。
